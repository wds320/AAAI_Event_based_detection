...
import os
import argparse
from dataloader.prophesee.src.metrics.coco_eval import evaluate_detection
from dataloader.prophesee.src.io.box_filtering import filter_boxes
from dataloader.prophesee.src.io.box_loading import reformat_boxes
...
def main():
    ...
    parser.add_argument('--camera', type=str, default='GEN1', help='GEN1 (QVGA) or GEN4 (720p)')
